...
namespace Metallic.Logging.Serilog.Console;

public static class Themes {

	public static SystemConsoleTheme Subtle { get; } = new(new Dictionary<ConsoleThemeStyle, SystemConsoleThemeStyle> {
	...
	public static SystemConsoleTheme Vainglorious { get; } = new SystemConsoleTheme(
